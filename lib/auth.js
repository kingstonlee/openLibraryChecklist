 ...
 * id is resolved by `getActingUserId(req)` (e.g. from a verified session token)
 * and must have an admin_users row. Sets req.actingUserId / req.actingRole on
 * success.
 * @param {{get: Function}} db
 * @param {(req: object) => (string|number|null)} getActingUserId
 * @returns {Function} Express middleware
 */
function requireAdmin(db, getActingUserId) {
